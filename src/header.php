...
<body>
    ...
    <header>
        <div class="first">
            <div class="flex logo">
                <a href="#" style="margin-top: 5%;"><img src="images/logo.jpg" alt=""></a>
                <div class="map flex">
        ...
        <div class="second">
            <div class="second-1" onclick="toggleSidebar()">
                <div>
                ...
                <nav class=" dark:bg-gray-900">
                    <div class="w-full">
                        ...
                        <div class=" w-full   id=" navbar-default">
                            <ul
                                class="container-fluid font-small flex flex-col  md:p-0 mt-3   md:flex-row  md:border-0">
                                <li>
                                    <a href="#"
                                        class="block py-2 px-3  no-underline text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white "
                                        aria-current="page">Natural Granite</a>
                                </li>
                                <li>

                                    <a href="#" class="block no-underline py-2 px-3 text-white "
                                        aria-current="page">Artificial
                                        Granite</a>
                                </li>
                                <li>

                                    <a href="#" class="block no-underline py-2 px-3 text-white " aria-current="page">
                                        Marbles
                                    </a>
                                </li>
                                <li>
